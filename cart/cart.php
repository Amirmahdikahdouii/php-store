        ...
        <div class="cart-list-item">
            ...
            <div class="cart-list-item-image-count-container">
                ...
                <div class="cart-list-item-mobile-product-title-container">
                    <a class="cart-list-item-title" href="#"><?php echo $product['name'] ?></a>
                </div>
                <div class="cart-list-item-count-container center">
                    ...
                    <span class="cart-list-item-count center"><?php echo $result[$i]['count'];?></span>
            ...
            <div class="cart-list-item-main-section">
                <h1 class="cart-list-item-title"> <?php echo $product['name'] ?></h1>
                ...
                <div class="cart-list-item-price-container">
                 <span class="cart-list-item-price"><?php echo $result[$i]['count'] * $product['price'] ?> </span>
                </div>
            </div>
        </div>
        <?php 
