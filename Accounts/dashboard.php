            ...
            <ul class="dashboard-section-info-list">
                ...
                ?>
                    <li class="dashboard-section-info-item">
                        ...
                        <span class="dashboard-section-info-item-key">Admin</span>
                        <span class="dashboard-section-info-item-value"><i class="bi bi-check2"></i></span>
                    </li>
                <?php
                }
                ?>
                <button id="edit-personal-info-button" onclick="showContentHandler('main-section-content-container-change-personal-info', 'change-personal-info')">Edit Profile</button>
            </ul>
        </div>
